...
public class TestAStar {
	...
	public void oneTimeSetUp() {
		...
		this.pathFound = TetheredAStarPathfinding.getShortestPath(g, sourceNode, this.destinationNode, tc, maxTetherLength);
	}
	...
	public void testPathShouldHaveCorrectLength() {
		...
		while (current != null) {
			...
			current = current.subPaths.size() != 0 ? current.subPaths.get(0).predecessorList.get(0) : null;
		}
